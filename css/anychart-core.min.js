...
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.kf($.Re("head")[0],c,0);rA=!0}this.Vc||(this.Vc=$.bf("DIV","anychart-credits"));this.j||(this.j=$.bf("A"),this.B=$.bf("SPAN","anychart-credits-text"),this.b=$.bf("IMG","anychart-credits-logo"),$.hf(this.j,this.B),this.Vc.appendChild(this.j));b=this.g.fj();this.W(ll)&&(b&&b.appendChild(this.Vc),this.U(ll));this.W(ml)&&(b=$.Aa.apply(null,[", v%s.%s.%s.%s"].concat(["8","0","1","1726"])),c=a?this.AB():"",
$.Te(this.j,{href:a?this.CB():"#",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.Te(this.b,{alt:a?this.BB():""}),this.U(ml));this.W(ul)&&(a=a?this.text():"",$.zf(this.B,a),this.U(ul));if(this.W(vl)){if(a=this.Kp()?this.Hx():xl()){if(this.ma=a,b=Zh($.Jg()))$.Kd(b,"complete",this.hV,!1,this),$.Kd(b,"load",this.tP,!1,this),$.Kd(b,"error",this.iV,!1,this),this.o&&(Lh(b,a),this.o=!1),$.Jh(b,a,a),this.o=
